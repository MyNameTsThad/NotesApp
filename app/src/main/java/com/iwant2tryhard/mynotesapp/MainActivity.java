...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.addMenuItem){
            ...
            db.addNote(new NoteObj("11", "11", formattedDate, formattedTime));
            db.addNote(new NoteObj("22", "22", formattedDate, formattedTime));
            db.addNote(new NoteObj("33", "33", formattedDate, formattedTime));
            db.addNote(new NoteObj("44", "44", formattedDate, formattedTime));
            db.addNote(new NoteObj("55", "55", formattedDate, formattedTime));
            db.addNote(new NoteObj("66", "66", formattedDate, formattedTime));
